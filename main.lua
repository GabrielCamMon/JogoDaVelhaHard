...
function novoJogo()
    ...
    buttonNovoJogo:setFillColor(255, 255, 255)
    texto = {x=display.contentCenterX, y=400, text="Novo Jogo"}
...
function createStateInitial()
    
    tabuleiro:realizarJogada(1, "X")
    tabuleiro:realizarJogada(2, "O")
    tabuleiro:realizarJogada(5, "X")
    tabuleiro:realizarJogada(6, "O")
    tabuleiro:realizarJogada(8, "X")
